              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    >
                      <FormControl>
                        <SelectTrigger className="dark:bg-[#1E1F22] bg-zinc-300/50 border-0 focus:ring-0 dark:text-zinc-300 ring-offset-0 focus:ring-offset-0 outline-none capitalize">
